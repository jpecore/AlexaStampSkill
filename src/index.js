...
var handlers = {
 ...
 "AMAZON.HelpIntent": function() {
  var speechText = "<p>Stamp Collector can help you do many things.</p>" + "<p>To get the defintion of a stamp term, say something like: What is Perforation?</p>" + "<p>To try and identify which country a stamp is from, spell some of the words like:  </p> " + "<p>What country has the letters c. t. o. c." + "Which command would you like to try?</p> " + "<p>See the Alexa App card for some moe examples.</p> ";
...
function handleStampFindIntentRequest(that) {
 ...
 var faceValue;
 var speechText = "You need to provide the name and face value of the stamp. " + "For example Find stamp name Detroit with face value three. How can I assit you?  ";
...
function isUSA(countrySlot) {
 return countrySlot.value == "US" || countrySlot.value == "USA" || countrySlot.value == "us" || countrySlot.value == "u s" || countrySlot.value == "United States" || countrySlot.value == "United States of America";
}; // end isUSA
//
function isUK(countrySlot) {
 return countrySlot.value == "UK" || countrySlot.value == "United Kingdom" || countrySlot.value == "GB" || countrySlot.value == "Great Britain" || countrySlot.value == "United Kingdom of Great Britain and Northern Ireland";
}; // end isUK
//
 ...
 getCAPI("/en/api/" + COLNECT_API_KEY + "/countries/cat/stamps/collection/jpecore", function(userCountries) {
  ...
  getCAPI("/en/api/" + COLNECT_API_KEY + "/countries/cat/stamps", function(allCountries) {
   ...
   if (countUserCounties < 1) {
    ...
    that.emit(':tell', "sorry, I could not find that user or the user has no collection. " + "Try setting the name again and spell slowly.");
